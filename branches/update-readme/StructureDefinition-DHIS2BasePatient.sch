...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://example.com/fhir/example/StructureDefinition/ConsentToBeContacted']) &lt;= 1">extension with URL = 'http://example.com/fhir/example/StructureDefinition/ConsentToBeContacted': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:birthDate">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.com/fhir/example/StructureDefinition/DateOfBirthIsEstimated']) &lt;= 1">extension with URL = 'http://example.com/fhir/example/StructureDefinition/DateOfBirthIsEstimated': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
